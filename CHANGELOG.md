...
-   [new-rule-option] Add whitespace rule for open braces
-   [new-rule-option] File name whitelist for [`file-name-casing`](https://palantir.github.io/tslint/rules/file-name-casing/) (#4206)
...
-   [new-rule-option][enhancement] [`import-blacklist`](https://palantir.github.io/tslint/rules/import-blacklist/): support blacklisting specific named exports (#3926)
-   [new-rule-option] `{ singleLine: "always" | "never"}` for rule [type-literal-delimiter](https://palantir.github.io/tslint/rules/type-literal-delimiter/) (#3964)
-   [new-rule-option]: `"snake-case"` in `"file-name-casing"` (#4081)
-   [new-rule] Enforce Blank Line after File Header (#3740)
...
-   [new-rule] `no-unnecessary-constructor` (#3647)
-   [new-rule] comment-type (#4008)
-   [new-rule] unnecessary-bind (#3588)
...
-   [bugfix] Correct the auto-fix code of [`prefer-method-signature`](https://palantir.github.io/tslint/rules/prefer-method-signature/) rule, now capable to handle (#4066)
-   [bugfix] Default logger.error should log to stderr. (#3982)
-   [bugfix] Files an issue where TSLint doesn't correctly resolve packages in a `node_modules` folder that are symlinked to another location where their dependencies are satisfied. (#4295)
...
-   [bugfix][`no-invalid-this`](https://palantir.github.io/tslint/rules/no-invalid-this/)](https://palantir.github.io/tslint/rules/no-invalid-this/) rule fixes false positives on method-like syntax and false negatives on nested functions (#4034)
...
-   [bugfix][`callable-types`](https://palantir.github.io/tslint/rules/callable-types/)](https://palantir.github.io/tslint/rules/callable-types/) support interfaces containing a single construct signature (#4291) (#4352)
...
-   [enhancement] When `grouped-imports` option of the [`ordered-imports`](https://palantir.github.io/tslint/rules/ordered-imports/) rule is set, the fact that imports of the same type are all in one group is also checked. (#3733)
